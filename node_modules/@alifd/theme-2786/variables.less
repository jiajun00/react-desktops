...
@color-brand1-1: #E1DCFD;

@color-brand1-6: #8272EC;

@color-brand1-9: #6755DD;
...
@color-other-2: #31323D;

@color-other-3: #1A1B22;

@color-line1-1: #434557;

@color-line1-2: #4D4F61;

@color-line1-3: #6B6F83;

@color-line1-4: #A7AABB;

@color-fill1-1: #333646;

@color-fill1-2: #474959;

@color-fill1-3: #4C4F60;

@color-fill1-4: #5C5F70;

@color-text1-1: #575867;

@color-text1-2: #767682;

@color-text1-3: #B1B1B8;

@color-text1-4: #FFFFFF;
...
@icon-font-path: "//at.alicdn.com/t/font_992535_5znhddfulz6";
...
@shadow-opacity-sd1: 0.2;

@shadow-opacity-sd2: 0.3;

@shadow-opacity-sd3: 0.4;
...
@checkbox-border-color: #A7AABB;

@checkbox-hovered-border-color: #8272EC;

@checkbox-checked-border-color: transparent;

@checkbox-disabled-border-color: #A7AABB;

@checkbox-checked-hovered-border-color: transparent;

@checkbox-checked-circle-color: #FFFFFF;

@checkbox-disabled-circle-color: #575867;

@checkbox-checked-hovered-circle-color: #FFFFFF;

@checkbox-bg-color: #5C5F70;

@checkbox-checked-bg-color: #8272EC;

@checkbox-hovered-bg-color: #E1DCFD;

@checkbox-checked-hovered-bg-color: #6755DD;

@checkbox-disabled-bg-color: #333646;
...
@timeline-item-title-color: #FFFFFF;

@timeline-item-body-color: #B1B1B8;

@timeline-item-left-body-color: #767682;

@timeline-item-time-color: #767682;

@timeline-item-tail-color: #4D4F61;

@timeline-item-done-dot-size: 8px;

@timeline-item-done-background: #6B6F83;

@timeline-item-done-color: #FFFFFF;

@timeline-item-process-dot-size: 8px;

@timeline-item-process-background: #8272EC;
...
@rating-normal-underlay-color: #474959;

@rating-normal-overlay-color: #8272EC;

@rating-normal-overlay-hover-color: #8272EC;

@rating-grade-low-overlay-color: #434557;

@rating-grade-low-overlay-hover-color: #767682;

@rating-grade-high-overlay-color: #8272EC;

@rating-grade-high-overlay-hover-color: #8272EC;


// ------------------------ split-button ------------------------ //

@split-btn-trigger-normal-icon-color: #767682;


// ------------------------ menu-button ------------------------ //

@menu-btn-disabled-icon-color: #575867;

@menu-btn-ghost-light-disabled-icon-color: rgba(0, 0, 0, 0.1);

@menu-btn-ghost-dark-disabled-icon-color: rgba(255, 255, 255, 0.4);

@menu-btn-pure-text-normal-icon-color: #767682;

@menu-btn-pure-text-primary-icon-color: #FFFFFF;

@menu-btn-pure-text-secondary-icon-color: #8272EC;

@menu-btn-text-text-normal-icon-color: #FFFFFF;

@menu-btn-text-text-primary-icon-color: #5584FF;

@menu-btn-ghost-light-icon-color: #FFFFFF;
...
@search-normal-corner: 2px;

@search-normal-primary-color: #8272EC;

@search-normal-primary-hover-color: #8272EC;

@search-normal-primary-split-color: #6B6F83;

@search-normal-primary-shadow: none;

@search-normal-primary-btn-text-color: #FFFFFF;

@search-normal-primary-btn-hover-bg-color: #6755DD;
...
@search-normal-secondary-color: #6B6F83;

@search-normal-secondary-split-color: #6B6F83;

@search-normal-secondary-hover-color: #8272EC;

@search-normal-secondary-shadow: none;

@search-normal-secondary-btn-bg-color: #8272EC;

@search-normal-secondary-btn-text-color: #FFFFFF;

@search-normal-secondary-btn-hover-bg-color: #6755DD;
...
@search-normal-normal-color: #6B6F83;

@search-normal-normal-split-color: #434557;

@search-normal-normal-hover-color: #A7AABB;

@search-normal-normal-shadow: none;

@search-normal-normal-btn-bg-color: #333646;

@search-normal-normal-btn-text-color: #B1B1B8;

@search-normal-normal-btn-hover-bg-color: #4C4F60;

@search-normal-normal-btn-hover-text-color: #FFFFFF;
...
@search-normal-dark-color: #8272EC;

@search-normal-dark-hover-color: #8272EC;
...
@search-normal-dark-btn-hover-bg-color: #6755DD;
...
@search-simple-corner: 2px;

@search-simple-l-icon-margin-right: 12px;

@search-simple-m-icon-margin-right: 8px;

@search-simple-normal-color: #6B6F83;

@search-simple-normal-hover-color: #A7AABB;

@search-simple-normal-split-color: #6B6F83;

@search-simple-normal-shadow: none;

@search-simple-normal-icon-text-color: #FFFFFF;

@search-simple-normal-icon-hover-text-color: #B1B1B8;
...
@search-simple-dark-color: #6B6F83;

@search-simple-dark-hover-color: #6B6F83;
...
@search-simple-dark-icon-text-color: #FFFFFF;

@search-simple-dark-icon-hover-text-color: #B1B1B8;

@search-simple-dark-btn-text-padding-left: 0;

@search-simple-dark-split-color: #6B6F83;
...
@cascader-menu-border-color: #4D4F61;

@cascader-menu-border-radius: 2px;

@cascader-menu-icon-expand-color: #B1B1B8;

@cascader-menu-icon-hover-expand-color: #FFFFFF;

@cascader-menu-item-expanded-color: #FFFFFF;

@cascader-menu-item-expanded-background-color: #474959;
...
@range-size-m-slider-shadow-moving: 2px 2px 4px 0px rgba(0, 0, 0, 0.3);

@range-normal-unselected-color: #6B6F83;

@range-normal-selected-color: #8272EC;

@range-normal-slider-bg-color: #434557;

@range-normal-mark-color: #767682;

@range-normal-mark-selected-color: #FFFFFF;

@range-normal-unselected-color-hover: #6B6F83;

@range-normal-selected-color-hover: #8272EC;

@range-normal-slider-bg-color-hover: #4D4F61;

@range-size-m-slider-shadow: 1px 1px 2px 0px rgba(0, 0, 0, 0.2);

@range-size-m-slider-shadow-hover: 4px 4px 12px 0px rgba(0, 0, 0, 0.4);

@range-normal-mark-color-hover: #767682;

@range-normal-mark-selected-color-hover: #FFFFFF;

@range-normal-slider-border-color-hover: transparent;

@range-normal-unselected-color-disabled: #6B6F83;

@range-normal-selected-color-disabled: #A7AABB;

@range-normal-slider-bg-color-disabled: #333646;

@range-normal-slider-border-color: #6B6F83;

@range-normal-slider-border-color-disabled: #A7AABB;

@range-normal-mark-color-disabled: #575867;

@range-normal-mark-selected-color-disabled: #767682;
...
@tree-node-normal-color: #FFFFFF;

@tree-node-normal-background: #333646;

@tree-node-title-border-radius: 2px;

@tree-switch-arrow-color: #767682;

@tree-switch-icon-color: #B1B1B8;

@tree-switch-bg-color: #FFFFFF;

@tree-switch-border-color: #6B6F83;

@tree-switch-corner: 2px;

@tree-line-color: #6B6F83;

@tree-line-style: solid;

@tree-node-hover-color: #FFFFFF;

@tree-node-hover-bg-color: #474959;

@tree-switch-hover-arrow-color: #FFFFFF;

@tree-switch-hover-icon-color: #FFFFFF;

@tree-switch-hover-bg-color: #474959;

@tree-switch-hover-border-color: #A7AABB;

@tree-node-selected-color: #8272EC;

@tree-node-selected-background: #E1DCFD;

@tree-node-disabled-color: #575867;

@tree-node-disabled-background: #333646;
...
@card-head-bottom-border-width: 0;
...
@card-background: #3A3C4B;

@card-header-background: #3A3C4B;

@card-title-color: #FFFFFF;

@card-sub-title-color: #B1B1B8;

@card-title-extra-color: #5584FF;

@card-title-bullet-color: #8272EC;
...
@switch-size-s-text-off-right: 0;

@switch-border-width-trigger: 1px;

@switch-normal-on-bg-color: #8272EC;

@switch-hover-on-bg-color: #6755DD;

@switch-disabled-on-bg-color: #333646;

@switch-normal-on-trigger-bg-color: #434557;

@switch-hover-on-trigger-bg-color: #FFFFFF;

@switch-disabled-on-trigger-bg-color: #333646;

@switch-normal-on-color-font: #FFFFFF;

@switch-disabled-on-color-font: #575867;

@switch-disabled-on-border-color: #6B6F83;

@switch-handle-on-border-color: transparent;

@switch-on-shadow: 1px 1px 2px 0px rgba(0, 0, 0, 0.2);

@switch-normal-off-bg-color: #5C5F70;

@switch-hover-off-bg-color: #474959;

@switch-disabled-off-bg-color: #333646;

@switch-normal-off-trigger-bg-color: #434557;

@switch-hover-off-trigger-bg-color: #FFFFFF;

@switch-disabled-off-trigger-bg-color: #333646;

@switch-handle-disabled-border-color: #A7AABB;

@switch-normal-off-color-font: #767682;

@switch-disabled-off-color-font: #6B6F83;

@switch-handle-off-border-color: transparent;

@switch-normal-off-border-color: #4D4F61;

@switch-hover-off-border-color: #6B6F83;

@switch-off-shadow: 1px 1px 2px 0px rgba(0, 0, 0, 0.2);
...
@input-label-color: #B1B1B8;

@input-hover-border-color: #A7AABB;

@input-hover-bg-color: #5C5F70;

@input-focus-border-color: #8272EC;

@input-focus-bg-color: #5C5F70;

@input-border-width: 1px;

@input-bg-color: #4C4F60;

@input-placeholder-color: #B1B1B8;

@input-disabled-color: #575867;

@input-disabled-border-color: #A7AABB;

@input-disabled-bg-color: #333646;
...
@input-multiple-corner: 2px;

@input-addon-bg-color: #474959;

@input-addon-text-color: #767682;
...
@input-maxlen-color: #767682;

@input-maxlen-font-size: 10px;

@input-hint-color: #767682;

@input-hint-hover-color: #B1B1B8;
...
@menu-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.2);

@menu-color: #FFFFFF;

@menu-divider-style: solid;

@menu-divider-color: #434557;

@menu-background: #3A3C4B;

@menu-arrow-color: #B1B1B8;

@menu-background-selected: #8272EC;

@menu-color-selected: #FFFFFF;

@menu-icon-selected-color: #8272EC;

@menu-background-hover: #474959;

@menu-color-hover: #FFFFFF;

@menu-arrow-color-hover: #FFFFFF;

@menu-icon-selected-hover-color: #8272EC;

@menu-color-disabled: #575867;
...
@btn-size-l-corner: 2px;

@btn-pure-color-disabled: #575867;

@btn-pure-bg-disabled: #333646;

@btn-pure-border-color-disabled: #6B6F83;

@btn-pure-normal-color: #FFFFFF;

@btn-pure-normal-color-hover: #FFFFFF;

@btn-pure-normal-bg: #4C4F60;

@btn-pure-normal-bg-hover: #333646;

@btn-pure-normal-border-color: #767682;

@btn-pure-normal-border-color-hover: #A7AABB;

@btn-pure-normal-border-style: solid;

@btn-pure-secondary-color: #8272EC;

@btn-pure-secondary-color-hover: #FFFFFF;

@btn-pure-secondary-bg: #FFFFFF;

@btn-pure-secondary-bg-hover: #6755DD;

@btn-pure-secondary-border-color: #FFFFFF;

@btn-pure-secondary-border-color-hover: #6755DD;
...
@btn-pure-primary-bg: #8272EC;

@btn-pure-primary-bg-hover: #6755DD;
...
@btn-ghost-light-color-hover: #767682;

@btn-ghost-light-border-color-hover: #FFFFFF;

@btn-ghost-light-bg-hover-rgb: #000000;

@btn-ghost-light-bg-hover-opacity: 0.84;
...
@btn-warning-primary-color-disabled: #575867;

@btn-warning-primary-border-color-disabled: #6B6F83;

@btn-warning-primary-bg-disabled: #333646;
...
@btn-warning-normal-bg: transparent;

@btn-warning-normal-bg-hover: #E72B00;

@btn-warning-normal-color-disabled: #575867;

@btn-warning-normal-border-color-disabled: #6B6F83;

@btn-warning-normal-bg-disabled: #333646;

@btn-text-primary-color: #5584FF;

@btn-text-primary-color-hover: #6755DD;

@btn-text-disabled-color: #575867;

@btn-text-loading-color: #FFFFFF;

@btn-text-secondary-color: #B1B1B8;

@btn-text-secondary-color-hover: #8272EC;

@btn-text-normal-color: #FFFFFF;

@btn-text-normal-color-hover: #8272EC;
...
@table-normal-border-color: #6B6F83;
...
@table-sort-color: #FFFFFF;

@table-group-th-bg: #4C4F60;

@table-group-th-color: #FFFFFF;

@table-row-bg: #333646;

@table-row-color: #FFFFFF;

@table-td-gray: #333646;

@table-td-normal: #FFFFFF;

@table-empty-color: #A7AABB;

@table-group-footer-bg: #4C4F60;

@table-group-footer-color: #FFFFFF;

@table-row-hover-bg: #474959;

@table-row-hover-color: #FFFFFF;

@table-row-selected-bg: #474959;

@table-row-selected-color: #FFFFFF;

@table-sort-color-current: #8272EC;

@table-expanded-ctrl-disabled-color: #767682;


// ------------------------ upload ------------------------ //

@upload-disable-text-color: #575867;

@upload-disable-border-color: #434557;
...
@upload-text-list-bg-color: #474959;

@upload-text-list-bg-color-hover: #474959;

@upload-text-list-bg-color-error: #FFECE4;

@upload-text-list-error-text-color: #FF3000;

@upload-text-list-close-icon-color: #FFFFFF;

@upload-text-list-close-icon-color-hover: #B1B1B8;

@upload-text-list-name-font-color: #FFFFFF;

@upload-text-list-name-font-color-hover: #8272EC;

@upload-text-list-size-font-color: #767682;

@upload-text-list-size-font-color-hover: #8272EC;
...
@upload-image-list-item-thumbnail-font-color: #575867;
...
@upload-image-list-item-bg-color: #333646;

@upload-image-list-close-icon-color: #767682;

@upload-image-list-close-icon-color-hover: #FFFFFF;

@upload-image-list-item-border-color: #A7AABB;

@upload-image-list-item-border-color-error: #FF3000;

@upload-image-list-item-border-color-hover: #8272EC;

@upload-image-list-item-picture-border-color: #4D4F61;

@upload-image-list-item-picture-background-color: #474959;
...
@upload-card-bg-color: #4C4F60;

@upload-card-border-style: dashed;

@upload-card-border-color: #6B6F83;

@upload-card-hover-border-color: #8272EC;

@upload-card-icon-color: #8272EC;

@upload-card-font-color: #FFFFFF;

@upload-card-hover-font-color: #8272EC;

@upload-card-list-uploading-bg-color: #333646;

@upload-card-list-bg-color-error: #333646;

@upload-card-list-margin-right: 12px;

@upload-card-list-border-color: #6B6F83;

@upload-card-list-border-color-error: #FF3000;

@upload-card-list-thumbnail-font-color: #575867;
...
@upload-card-list-name-font-color: #B1B1B8;

@upload-drag-zone-border-color: #6B6F83;

@upload-drag-zone-over-border-color: #8272EC;

@upload-drag-zone-corner: 2px;
...
@tag-normal-text-color: #FFFFFF;

@tag-fill-text-color: #B1B1B8;
...
@tag-closable-normal-bg: #6B6F83;

@tag-closable-normal-bg-hover: #A7AABB;

@tag-closable-normal-bg-disabled: #434557;

@tag-closable-bordered-text-color: #B1B1B8;

@tag-closable-bordered-border-color: #6B6F83;

@tag-closable-bordered-bg: transparent;

@tag-closable-bordered-text-color-hover: #FFFFFF;

@tag-closable-bordered-border-color-hover: #A7AABB;

@tag-closable-bordered-bg-hover: transparent;

@tag-closable-bordered-tail-color: #B1B1B8;

@tag-closable-bordered-tail-color-hover: #FFFFFF;

@tag-closable-bordered-tail-color-disabled: #575867;

@tag-closable-bordered-border-color-disabled: #434557;

@tag-closable-bordered-text-color-disabled: #575867;

@tag-closable-bordered-bg-disabled: transparent;

@tag-fill-tail-color: #B1B1B8;

@tag-fill-text-color-disabled: #575867;

@tag-fill-border-color-disabled: #333646;

@tag-fill-bg-color-disabled: #333646;

@tag-fill-tail-color-disabled: #575867;

@tag-primary-text-color: #FFFFFF;

@tag-primary-bg-color: #8272EC;

@tag-primary-tail-color: #FFFFFF;

@tag-bordered-text-color: #B1B1B8;

@tag-bordered-tail-color: #B1B1B8;

@tag-secondary-text-color: #8272EC;

@tag-normal-text-color-hover: #8272EC;

@tag-fill-text-color-hover: #FFFFFF;

@tag-fill-tail-color-hover: #FFFFFF;

@tag-primary-text-color-hover: #FFFFFF;

@tag-primary-tail-color-hover: #FFFFFF;

@tag-bordered-text-color-hover: #FFFFFF;

@tag-bordered-tail-color-hover: #FFFFFF;

@tag-bordered-tail-color-disabled: #575867;

@tag-bordered-text-color-disabled: #575867;

@tag-bordered-border-color-disabled: #A7AABB;

@tag-bordered-bg-disabled: #333646;

@tag-secondary-text-color-hover: #6755DD;

@tag-bordered-border-color: #6B6F83;

@tag-secondary-border-color: #8272EC;

@tag-checkable-normal-bg-selected: #8272EC;

@tag-checkable-secondary-bg-selected: #8272EC;

@tag-bordered-border-color-hover: #A7AABB;

@tag-secondary-border-color-hover: #6755DD;

@tag-checkable-normal-bg-selected-hover: #6755DD;

@tag-checkable-secondary-bg-selected-hover: #6755DD;

@tag-fill-bg-color: #4C4F60;

@tag-primary-background-color: #8272EC;

@tag-bordered-bg: transparent;

@tag-secondary-bg: transparent;

@tag-fill-bg-color-hover: #5C5F70;

@tag-primary-bg-color-hover: #6755DD;

@tag-bordered-bg-hover: transparent;

@tag-secondary-bg-hover: transparent;

@tag-text-color-disabled: #575867;

@tag-border-color-disabled: #434557;

@tag-checkable-fill-text-color: #B1B1B8;

@tag-checkable-fill-bg-color: #4C4F60;

@tag-checkable-fill-text-color-hover: #FFFFFF;

@tag-checkable-fill-bg-color-hover: #5C5F70;

@tag-checkable-fill-tail-color: #B1B1B8;

@tag-checkable-fill-tail-color-hover: #FFFFFF;

@tag-checkable-fill-tail-color-disabled: #575867;

@tag-checkable-fill-text-color-disabled: #575867;

@tag-checkable-fill-border-color-disabled: #333646;

@tag-checkable-fill-bg-color-disabled: #333646;

@tag-checkable-normal-text-color: #B1B1B8;

@tag-checkable-normal-border-color: #6B6F83;

@tag-checkable-normal-bg: transparent;

@tag-checkable-normal-text-color-hover: #FFFFFF;

@tag-checkable-normal-border-color-hover: #6B6F83;

@tag-checkable-normal-bg-hover: transparent;

@tag-checkable-normal-text-selected-disabled: #575867;

@tag-checkable-normal-border-selected-disabled: #A7AABB;

@tag-checkable-normal-bg-selected-disabled: #333646;

@tag-checkable-normal-tick-bg-selected-disabled: #474959;

@tag-checkable-primary-text-color: #FFFFFF;

@tag-checkable-primary-bg-color: #8272EC;

@tag-checkable-primary-text-color-hover: #FFFFFF;

@tag-checkable-primary-bg-color-hover: #6755DD;

@tag-checkable-primary-tail-color: #FFFFFF;

@tag-checkable-primary-tail-color-hover: #FFFFFF;

@tag-checkable-secondary-bg-selected-disabled: #434557;

@tag-primary-bg-color-disabled: #E1DCFD;

@tag-checkable-normal-icon-color-selected: #FFFFFF;

@tag-checkable-normal-icon-color-selected-hover: #FFFFFF;

@tag-checkable-normal-icon-color-selected-disabled: #575867;
...
@select-hint-color: #767682;

@select-highlight-color: #8272EC;
...
@message-size-l-border-width: 1px;
...
@message-border-radius-toast: 2px;

@message-border-style-toast: solid;

@message-shadow-toast: 0px 4px 12px 0px rgba(0, 0, 0, 0.4);

@message-success-color-bg-inline: #E4FDDA;

@message-success-color-bg-addon: transparent;

@message-success-color-bg-toast: #333646;

@message-success-color-border-inline: #E4FDDA;

@message-success-color-border-toast: #6B6F83;

@message-success-color-title-inline: #575867;

@message-success-color-title-addon: #FFFFFF;

@message-success-color-title-toast: #FFFFFF;

@message-success-color-content-inline: #767682;

@message-success-color-content-addon: #B1B1B8;

@message-success-color-content-toast: #B1B1B8;
...
@message-error-color-bg-toast: #333646;

@message-error-color-border-inline: #FFECE4;

@message-error-color-border-toast: #6B6F83;

@message-error-color-title-inline: #575867;

@message-error-color-title-addon: #FFFFFF;

@message-error-color-title-toast: #FFFFFF;

@message-error-color-content-inline: #767682;

@message-error-color-content-addon: #B1B1B8;

@message-error-color-content-toast: #B1B1B8;
...
@message-warning-color-bg-toast: #333646;

@message-warning-color-border-inline: #FFF3E0;

@message-warning-color-border-toast: #6B6F83;

@message-warning-color-title-inline: #575867;

@message-warning-color-title-addon: #FFFFFF;

@message-warning-color-title-toast: #FFFFFF;

@message-warning-color-content-inline: #767682;

@message-warning-color-content-addon: #B1B1B8;

@message-warning-color-content-toast: #B1B1B8;
...
@message-notice-color-bg-toast: #333646;

@message-notice-color-border-inline: #E3F2FD;

@message-notice-color-border-toast: #6B6F83;

@message-notice-color-title-inline: #575867;

@message-notice-color-title-addon: #FFFFFF;

@message-notice-color-title-toast: #FFFFFF;

@message-notice-color-content-inline: #767682;

@message-notice-color-content-addon: #B1B1B8;

@message-notice-color-content-toast: #B1B1B8;
...
@message-help-color-bg-toast: #333646;

@message-help-color-border-inline: #E3FFF8;

@message-help-color-border-toast: #6B6F83;

@message-help-color-title-inline: #575867;

@message-help-color-title-addon: #FFFFFF;

@message-help-color-title-toast: #FFFFFF;

@message-help-color-content-inline: #767682;

@message-help-color-content-addon: #B1B1B8;

@message-help-color-content-toast: #B1B1B8;
...
@message-loading-color-bg-toast: #333646;

@message-loading-color-border-inline: #FFFFFF;

@message-loading-color-border-toast: #6B6F83;

@message-loading-color-title-inline: #575867;

@message-loading-color-title-addon: #FFFFFF;

@message-loading-color-title-toast: #FFFFFF;

@message-loading-color-content-inline: #767682;

@message-loading-color-content-addon: #B1B1B8;

@message-loading-color-content-toast: #B1B1B8;

@message-loading-color-icon-inline: #8272EC;

@message-loading-color-icon-addon: #8272EC;

@message-loading-color-icon-toast: #8272EC;

@message-close-icon-color: #767682;

@message-hover-close-icon-color: #B1B1B8;
...
@dialog-border-color: #A7AABB;

@dialog-border-style: solid;

@dialog-corner: 2px;

@dialog-shadow: 0px 4px 12px 0px rgba(0, 0, 0, 0.4);
...
@dialog-content-color: #B1B1B8;

@dialog-footer-bg-color: transparent;

@dialog-footer-border-color: transparent;

@dialog-close-color: #FFFFFF;

@dialog-close-color-hovered: #FFFFFF;
...
@progress-line-underlay-color: #4C4F60;

@progress-line-underlay-border-color: #4D4F61;
...
@progress-line-font-color: #FFFFFF;

@progress-line-normal-color: #8272EC;
...
@progress-circle-underlay-color: #4C4F60;

@progress-circle-text-color: #FFFFFF;

@progress-circle-corner: round;

@progress-circle-normal-color: #8272EC;
...
@balloon-normal-color-bg: #31323D;

@balloon-normal-color-border: transparent;

@balloon-normal-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.2);

@balloon-normal-color: #FFFFFF;

@balloon-normal-color-close: #FFFFFF;

@balloon-normal-color-close-hover: #B1B1B8;

@balloon-primary-color-bg: #8272EC;

@balloon-primary-color-border: transparent;

@balloon-primary-shadow: 0px 1px 2px 0px rgba(0, 0, 0, 0.2);

@balloon-primary-color: #FFFFFF;

@balloon-primary-color-close: #FFFFFF;

@balloon-primary-color-close-hover: #FFFFFF;

@balloon-tooltip-color-bg: #474959;

@balloon-tooltip-color-border: #4D4F61;
...
@transfer-simple-move-icon-color: #6B6F83;

@transfer-panel-border-color: #6B6F83;

@transfer-panel-border-corner: 2px;

@transfer-panel-background-color: #5C5F70;

@transfer-panel-header-text-color: #FFFFFF;

@transfer-panel-header-background-color: #333646;

@transfer-panel-search-icon-color: #767682;

@transfer-panel-footer-text-color: #FFFFFF;

@transfer-panel-footer-background-color: #333646;

@transfer-simple-panel-footer-text-color: #8272EC;

@transfer-simple-panel-item-hover-text-color: #8272EC;
...
@collapse-border-corner: 2px;

@collapse-border-color: #4D4F61;

@collapse-panel-border-color: #4D4F61;

@collapse-disabled-border-color: #A7AABB;

@collapse-title-border-width: 1px;

@collapse-title-height: 20px;

@collapse-title-bg-color: #474959;

@collapse-title-hover-bg-color: #4C4F60;

@collapse-title-disabled-bg-color: #333646;

@collapse-title-font-color: #FFFFFF;

@collapse-title-font-disabled-color: #575867;
...
@collapse-content-bg-color: #5C5F70;
...
@pagination-ellipsis-color: #767682;

@pagination-current-color: #8272EC;

@pagination-total-color: #FFFFFF;

@pagination-jump-color: #767682;

@pagination-size-selector-title-color: #767682;

@pagination-size-selector-filter-color: #B1B1B8;

@pagination-size-selector-filter-current-color: #8272EC;

@pagination-item-current-color: #FFFFFF;

@pagination-arrow-hover-color: #FFFFFF;

@pagination-arrow-hover-color-noboder: #8272EC;

@pagination-arrow-color: #B1B1B8;

@pagination-item-current-border-color: #8272EC;

@pagination-item-current-bg: #8272EC;

@pagination-item-current-hover-color: #FFFFFF;

@pagination-item-current-hover-border-color: #8272EC;

@pagination-item-current-hover-bg: #8272EC;
...
@time-picker-menu-border-color: #6B6F83;

@time-picker-menu-title-color: #767682;

@time-picker-menu-title-background: #FFFFFF;

@time-pikcer-menu-title-font-weight: normal;

@time-picker-menu-item-color: #B1B1B8;

@time-picker-menu-item-color-hover: #FFFFFF;

@time-picker-menu-item-color-selected: #B1B1B8;

@time-picker-menu-item-color-disabled: #575867;

@time-picker-menu-item-background: #FFFFFF;

@time-picker-menu-item-background-hover: #474959;

@time-picker-menu-item-background-selected: #474959;
...
@slick-dots-background-color-selected: #8272EC;
...
@slick-arrow-icon-color-normal-outer: #B1B1B8;

@slick-arrow-icon-color-hover: #FFFFFF;

@slick-arrow-icon-color-hover-outer: #FFFFFF;

@slick-arrow-icon-color-disabled: #575867;

@slick-arrow-icon-color-disabled-outer: #575867;

@slick-arrow-bg-color-normal: #000000;

@slick-arrow-bg-color-hover: #000000;

@slick-arrow-bg-color-disabled: #333646;
...
@radio-bg-color: #5C5F70;

@radio-hovered-bg-color: #E1DCFD;

@radio-checked-bg-color: #8272EC;

@radio-disabled-bg-color: #333646;

@radio-checked-hovered-bg-color: #6755DD;

@radio-border-color: #A7AABB;

@radio-hovered-border-color: #8272EC;

@radio-checked-border-color: #8272EC;

@radio-disabled-border-color: #A7AABB;

@radio-checked-hovered-border-color: transparent;

@radio-checked-circle-color: #FFFFFF;

@radio-disabled-circle-color: #575867;

@radio-checked-hovered-circle-color: #FFFFFF;

@radio-normal-font-color: #FFFFFF;

@radio-normal-font-color-disabled: #575867;
...
@radio-button-corner-large: 2px;

@radio-button-corner-medium: 2px;

@radio-button-corner-small: 2px;
...
@radio-button-bg-color: #4C4F60;

@radio-button-bg-color-hovered: #474959;

@radio-button-bg-color-checked: #8272EC;

@radio-button-bg-color-disabled: #333646;

@radio-button-bg-color-checked-disabled: #474959;

@radio-button-border-color: #4D4F61;

@radio-button-border-color-hovered: #6B6F83;

@radio-button-border-color-checked: #8272EC;

@radio-button-border-color-disabled: #6B6F83;

@radio-button-border-color-checked-disabled: #6B6F83;

@radio-button-font-color: #FFFFFF;

@radio-button-font-color-hovered: #FFFFFF;

@radio-button-font-color-checked: #FFFFFF;

@radio-button-font-color-disabled: #575867;

@radio-button-font-color-checked-disabled: #575867;
...
@step-arrow-item-wait-background: #4C4F60;

@step-arrow-item-title-wait-color: #767682;

@step-arrow-item-process-background: #8272EC;

@step-arrow-item-title-process-color: #FFFFFF;

@step-arrow-item-finish-background: #E1DCFD;

@step-arrow-item-title-finish-color: #8272EC;

@step-arrow-item-disabled-background: #333646;

@step-arrow-item-title-disabled-color: #575867;
...
@step-circle-item-tail-wait-color: #6B6F83;

@step-circle-item-tail-process-color: #6B6F83;

@step-circle-item-tail-finish-color: #8272EC;

@step-circle-item-tail-disabled-color: #A7AABB;
...
@step-circle-item-title-wait-color: #B1B1B8;

@step-circle-item-title-process-color: #FFFFFF;

@step-circle-item-title-finish-color: #B1B1B8;

@step-circle-item-title-disabled-color: #575867;

@step-circle-item-node-wait-border-color: #474959;

@step-circle-item-node-wait-background: #333646;

@step-circle-item-node-wait-color: #B1B1B8;

@step-circle-item-node-process-border-color: #8272EC;

@step-circle-item-node-process-background: #8272EC;

@step-circle-item-node-process-color: #FFFFFF;

@step-circle-item-node-process-percent-color: #8272EC;

@step-circle-item-node-finish-border-color: #8272EC;

@step-circle-item-node-finish-background: #8272EC;

@step-circle-item-node-finish-color: #FFFFFF;

@step-circle-item-node-disabled-border-color: #A7AABB;

@step-circle-item-node-disabled-background: #333646;

@step-circle-item-node-disabled-color: #E1DCFD;
...
@step-circle-item-content-color: #B1B1B8;

@step-circle-item-tail-bg-color: #434557;
...
@step-dot-item-tail-wait-color: #6B6F83;

@step-dot-item-tail-process-color: #6B6F83;

@step-dot-item-tail-finish-color: #8272EC;

@step-dot-item-tail-disabled-color: #A7AABB;

@step-dot-item-title-wait-color: #B1B1B8;

@step-dot-item-title-process-color: #FFFFFF;

@step-dot-item-title-finish-color: #B1B1B8;

@step-dot-item-title-disabled-color: #575867;

@step-dot-item-node-wait-border-color: #5C5F70;

@step-dot-item-node-wait-background: #5C5F70;

@step-dot-item-node-wait-color: #767682;

@step-dot-item-node-process-border-color: #8272EC;

@step-dot-item-node-process-background: #8272EC;

@step-dot-item-node-process-color: #8272EC;

@step-dot-item-node-finish-border-color: #8272EC;

@step-dot-item-node-finish-background: #8272EC;

@step-dot-item-node-finish-color: #8272EC;

@step-dot-item-node-disabled-border-color: #A7AABB;

@step-dot-item-node-disabled-background: #333646;

@step-dot-item-node-disabled-color: #434557;
...
@step-dot-item-content-color: #B1B1B8;

@step-dot-item-tail-bg-color: #434557;
...
@nav-secondary-item-hover-bg-color: #6755DD;

@nav-secondary-item-hover-text-color: #FFFFFF;

@nav-secondary-sub-nav-hover-bg-color: #6755DD;

@nav-secondary-sub-nav-hover-text-color: #FFFFFF;

@nav-secondary-item-selected-bg-color: #6755DD;

@nav-secondary-item-selected-text-color: #FFFFFF;

@nav-secondary-item-selected-text-style: bold;

@nav-secondary-item-selected-active-color: #6755DD;

@nav-secondary-sub-nav-selected-bg-color: #6755DD;

@nav-secondary-sub-nav-selected-text-color: #FFFFFF;

@nav-secondary-sub-nav-active-color: #8272EC;

@nav-secondary-item-opened-bg-color: #6755DD;

@nav-secondary-item-opened-text-color: #FFFFFF;

@nav-normal-bg-color: #333646;

@nav-normal-border-color: #6B6F83;

@nav-normal-text-color: #FFFFFF;

@nav-normal-text-style: normal;

@nav-normal-border-line: 1px;

@nav-normal-shadow: 2px 2px 4px 0px rgba(0, 0, 0, 0.3);

@nav-normal-sub-nav-bg-color: #333646;

@nav-normal-sub-nav-text-color: #FFFFFF;

@nav-normal-sub-nav-text-style: normal;

@nav-normal-group-text-color: #767682;

@nav-normal-group-text-style: normal;

@nav-normal-item-hover-bg-color: #3A3C4B;

@nav-normal-item-hover-text-color: #FFFFFF;

@nav-normal-sub-nav-hover-bg-color: #474959;

@nav-normal-sub-nav-hover-text-color: #8272EC;

@nav-normal-item-selected-bg-color: #3A3C4B;

@nav-normal-item-selected-text-color: #8272EC;

@nav-normal-item-selected-text-style: bold;

@nav-normal-item-selected-active-color: #8272EC;

@nav-normal-sub-nav-selected-bg-color: #474959;

@nav-normal-sub-nav-selected-text-color: #8272EC;

@nav-normal-sub-nav-active-color: #8272EC;

@nav-normal-item-opened-bg-color: #474959;

@nav-normal-item-opened-text-color: #8272EC;

@nav-line-bg-color: transparent;

@nav-line-border-color: #6B6F83;

@nav-line-text-color: #FFFFFF;
...
@nav-line-sub-nav-text-color: #FFFFFF;

@nav-line-sub-nav-text-style: normal;

@nav-line-item-hover-bg-color: transparent;

@nav-line-item-hover-text-color: #8272EC;

@nav-line-sub-nav-hover-bg-color: transparent;

@nav-line-sub-nav-hover-text-color: #8272EC;

@nav-line-item-selected-bg-color: transparent;

@nav-line-item-selected-text-color: #8272EC;

@nav-line-item-selected-text-style: bold;

@nav-line-item-selected-active-color: #8272EC;

@nav-line-sub-nav-selected-bg-color: transparent;

@nav-line-sub-nav-selected-text-color: #8272EC;

@nav-line-sub-nav-active-color: #8272EC;

@nav-line-item-opened-bg-color: transparent;

@nav-line-item-opened-text-color: #8272EC;

@nav-line-group-text-color: #767682;
...
@tab-close-icon-color: #B1B1B8;

@tab-close-icon-color-hover: #FFFFFF;

@tab-close-icon-color-selected: #8272EC;

@tab-close-icon-color-disabled: #4D4F61;

@tab-item-font-weight-selected: normal;

@tab-nav-arrow-color-normal: #B1B1B8;

@tab-nav-arrow-color-hover: #FFFFFF;

@tab-nav-arrow-color-disabled: #4D4F61;

@tab-pure-divider-line-width: 1px;

@tab-pure-ink-bar-width: 2px;

@tab-pure-text-color-normal: #B1B1B8;

@tab-pure-bg-color: transparent;

@tab-pure-text-color-hover: #4494F9;

@tab-pure-text-color-selected: #8272EC;

@tab-pure-text-color-disabled: #4D4F61;

@tab-pure-ink-bar-color: #8272EC;

@tab-pure-divider-border-color: #4D4F61;
...
@tab-wrapped-tab-corner-radius: 2px;
...
@tab-wrapped-ink-bar-color: #8272EC;

@tab-wrapped-nav-item-border-color-active: #8272EC;

@tab-wrapped-border-line-color: #4D4F61;

@tab-wrapped-content-border-line-width: 1px;

@tab-wrapped-content-border-line-style: solid;

@tab-wrapped-content-border-line-color: #4D4F61;

@tab-wrapped-text-color: #B1B1B8;

@tab-wrapped-text-color-hover: #FFFFFF;

@tab-wrapped-bg-color: #474959;

@tab-wrapped-bg-color-hover: #4C4F60;

@tab-wrapped-border-line-color-hover: #6B6F83;

@tab-wrapped-text-color-selected: #FFFFFF;

@tab-wrapped-text-color-disabled: #575867;

@tab-wrapped-bg-color-selected: #8272EC;

@tab-wrapped-bg-color-disabled: #333646;

@tab-capsule-text-color: #FFFFFF;

@tab-capsule-text-color-hover: #FFFFFF;

@tab-capsule-text-color-selected: #FFFFFF;

@tab-capsule-text-color-disabled: #575867;

@tab-capsule-bg-color: #474959;

@tab-capsule-bg-color-hover: #4C4F60;

@tab-capsule-bg-color-selected: #8272EC;

@tab-capsule-bg-color-disabled: #333646;

@tab-capsule-tab-border-line-color: #6B6F83;

@tab-capsule-tab-border-line-color-hover: #8272EC;

@tab-capsule-tab-border-line-color-active: #8272EC;

@tab-capsule-tab-border-line-color-disabled: #434557;

@tab-capsule-corner-radius: 2px;
...
@tab-text-item-sep-color: #4D4F61;

@tab-text-text-color-normal: #B1B1B8;

@tab-text-text-color-hover: #FFFFFF;

@tab-text-text-color-selected: #8272EC;

@tab-text-text-color-disabled: #575867;
...
@calendar-fullscreen-table-head-color: #FFFFFF;

@calendar-fullscreen-table-cell-normal-background: #474959;

@calendar-fullscreen-table-cell-normal-color: #FFFFFF;

@calendar-fullscreen-table-cell-normal-border-color: #4D4F61;

@calendar-fullscreen-table-cell-hover-background: #E1DCFD;

@calendar-fullscreen-table-cell-hover-color: #8272EC;

@calendar-fullscreen-table-cell-hover-border-color: #8272EC;

@calendar-fullscreen-table-cell-select-background: #E1DCFD;

@calendar-fullscreen-table-cell-select-color: #8272EC;

@calendar-fullscreen-table-cell-select-border-color: #8272EC;

@calendar-fullscreen-table-cell-select-font-weight: bold;

@calendar-fullscreen-table-cell-current-background: #4C4F60;

@calendar-fullscreen-table-cell-current-color: #8272EC;

@calendar-fullscreen-table-cell-current-border-color: #8272EC;

@calendar-fullscreen-table-cell-current-font-weight: bold;

@calendar-fullscreen-table-cell-other-background: transparent;

@calendar-fullscreen-table-cell-other-color: #575867;

@calendar-fullscreen-table-cell-other-border-color: transparent;

@calendar-fullscreen-table-cell-disabled-background: #333646;

@calendar-fullscreen-table-cell-disabled-color: #575867;

@calendar-fullscreen-table-cell-disabled-border-color: #575867;
...
@calendar-card-table-cell-date-border-radius: 2px;

@calendar-card-table-cell-month-border-radius: 2px;

@calendar-card-table-cell-year-border-radius: 2px;

@calendar-card-table-head-color: #767682;

@calendar-card-table-cell-corner: 0;

@calendar-card-table-cell-normal-background: #474959;

@calendar-card-table-cell-normal-color: #B1B1B8;

@calendar-card-table-cell-normal-border-color: #4D4F61;

@calendar-card-table-cell-hover-background: #E1DCFD;

@calendar-card-table-cell-hover-color: #8272EC;

@calendar-card-table-cell-hover-border-color: #E1DCFD;

@calendar-card-table-cell-select-background: #8272EC;

@calendar-card-table-cell-select-color: #FFFFFF;

@calendar-card-table-cell-select-border-color: #8272EC;

@calendar-card-table-cell-select-font-weight: bold;

@calendar-card-table-cell-other-background: #E1DCFD;

@calendar-card-table-cell-other-color: #575867;

@calendar-card-table-cell-other-border-color: #E1DCFD;

@calendar-card-table-cell-disabled-background: #333646;

@calendar-card-table-cell-disabled-color: #575867;

@calendar-card-table-cell-disabled-border-color: #333646;

@calendar-card-table-cell-current-background: #E1DCFD;

@calendar-card-table-cell-current-color: #8272EC;

@calendar-card-table-cell-current-border-color: #E1DCFD;

@calendar-card-table-cell-current-font-weight: bold;

@calendar-card-table-cell-inrange-background: #E1DCFD;

@calendar-card-table-cell-inrange-color: #8272EC;

@calendar-card-table-cell-inrange-border-color: #E1DCFD;
...
@calendar-panel-header-background: #8272EC;
...
@breadcrumb-text-color: #B1B1B8;

@breadcrumb-text-current-color: #FFFFFF;

@breadcrumb-text-current-weight: normal;

@breadcrumb-text-ellipsis-color: #B1B1B8;

@breadcrumb-text-keyword-color: #8272EC;

@breadcrumb-icon-color: #5C5F70;

@breadcrumb-text-color-hover: #8272EC;

@breadcrumb-text-current-color-hover: #8272EC;

@breadcrumb-text-keyword-color-hover: #8272EC;
...
@date-picker-panel-time-panel-separator-color: #4D4F61;
...
@form-element-small-corner: 2px;

@form-element-medium-corner: 2px;

@form-element-large-corner: 2px;
...
@popup-local-border-color: transparent;

@popup-local-corner: 2px;
...
@popup-global-border-color: #4D4F61;

@popup-global-corner: 2px;

@popup-global-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.3);
