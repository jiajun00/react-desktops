...
export default fromJS({
  ...
  desktopApps:[ //桌面应用图标
    ...
    {name:'博客', type:'qqxio', logo:QqxioImg,isShow:true,url:'http://www.qqxio.cn',isIframe:true,isBlank:false,sort:2},
    {name:'文件2',type:'filename3',logo:FileImg1,isShow:true,url:'/win/system',isIframe:true,isBlank:false,sort:3},
    {name:'文件3',type:'filename4',logo:FileImg1,isShow:true,url:'/win/system',isIframe:true,isBlank:false,sort:4},
